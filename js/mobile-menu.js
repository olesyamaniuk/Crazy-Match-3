document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-s-navigation-list");
  const headerRef = document.querySelector(".q-s-header");
  const navigationRef = document.querySelector(".q-s-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".q-s-toggle-button img");

  if (answer.style.display === "none" || answer.style.display === "") {
    answer.style.display = "block";
    buttonImg.src = "/img/xmark.png";
  } else {
